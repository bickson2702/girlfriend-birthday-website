...
```bash
git remote add encore encore://girlfriend-birthday-website-cmqi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/girlfriend-birthday-website-cmqi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/girlfriend-birthday-website-cmqi/settings/integrations/github)
